...
with open("health.dat", "rb") as fin:
    hp1 = int(pickle.load(fin))
with open("total_health.dat", "rb") as fin:
        ...
        while hp1 > 0 and hp2 > 0:
            if turn % 2 == 1:
                ...
                if hp1 == 0 and floor == 16:
                    ...
                    os.remove("total_health.dat")
                    os.remove("enchant.dat")
                    sys.exit(
