...
def avatar():
    ...
    if stats["Luck"] >= 21:
        health = 3 * (int(stats["Constitution"]) + 2 * (random.randint(15, 20)))
    elif stats["Luck"] >= 15:
        health = 3 * (int(stats["Constitution"]) + 2 * (random.randint(10, 20)))
    else:
        health = 3 * (int(stats["Constitution"]) + 2 * (random.randint(1, 20)))
